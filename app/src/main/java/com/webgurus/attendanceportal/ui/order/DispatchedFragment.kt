...
class DispatchedFragment : BaseFragment(), RecyclerViewRoleClickListeners,
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dispatchordered, container, false)
    }
    ...
    private fun showDialogtoUpdateOrderStatus(Itemid: Int, status: Int) {
        ...
        with(spinner)
        {
            ...
            onItemSelectedListener = this@DispatchedFragment
            layoutParams = ll
    ...
    private fun hitApitoGetOrderListing() {
        ...
        val service =
            RetrofitClientInstance.getRetrofitInstance().create(GetDataService::class.java)
        val call =
            service.getdispatchedItemsListing("Bearer " + sharedPreferences!!.getString("Access_Token", ""))
