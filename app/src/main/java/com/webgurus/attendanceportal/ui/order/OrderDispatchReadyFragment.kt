...
class OrderDispatchReadyFragment : BaseFragment(), RecyclerViewRoleClickListeners,
    ...
    private fun showDialogtoUpdateOrderStatus(Itemid: Int, status: Int) {
        ...
        with(spinner)
        {
            ...
            onItemSelectedListener = this@OrderDispatchReadyFragment
            layoutParams = ll
    ...
    private fun hitApitoGetOrderListing() {
        ...
        val call = service.getdispatchedreadyListing("Bearer " + sharedPreferences!!.getString("Access_Token", ""))
        call.enqueue(object : retrofit2.Callback<OrderListingPojo> {
            override fun onResponse(
                ...
                if (response.body() != null) {
                    ...
                    rv_orderlisting.layoutManager = LinearLayoutManager(activity, RecyclerView.VERTICAL, false)
                    adapter = OrderListingAdapter(
                        requireActivity(),
                        mOrderList,
                        this@OrderDispatchReadyFragment,
                        this@OrderDispatchReadyFragment
                    )
