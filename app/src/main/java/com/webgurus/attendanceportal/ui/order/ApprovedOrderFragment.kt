...
class ApprovedOrderFragment : BaseFragment(), RecyclerViewRoleClickListeners,
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_approvedorder, container, false)
    }
    ...
    private fun showDialogtoUpdateOrderStatus(Itemid: Int, status: Int) {
        ...
        with(spinner)
        {
            ...
            onItemSelectedListener = this@ApprovedOrderFragment
            layoutParams = ll
    ...
    private fun hitApitoGetOrderListing() {
        ...
        val service =
            RetrofitClientInstance.getRetrofitInstance().create(GetDataService::class.java)
        val call =
            service.getapprovedOrder("Bearer " + sharedPreferences!!.getString("Access_Token", ""))
