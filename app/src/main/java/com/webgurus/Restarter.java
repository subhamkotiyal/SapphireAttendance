...
import com.webgurus.endlessservice.Globals;
import com.webgurus.endlessservice.JobService;
import com.webgurus.endlessservice.RestartBroadcastReceiver;
import com.webgurus.endlessservice.ServiceAdmin;
import com.webgurus.newservice.MyEndlessService;
import com.webgurus.newservice.MyEndlessService22;
...
//            context.startForegroundService(new Intent(context, MyEndlessService22.class));
//            new LocalDatabaseForException(context,strDate,"Services Restarted").execute();
//        } else {
//            context.startService(new Intent(context, MyEndlessService22.class));
//            new LocalDatabaseForException(context,strDate,"Services Restarted").execute();
//        }
    }
