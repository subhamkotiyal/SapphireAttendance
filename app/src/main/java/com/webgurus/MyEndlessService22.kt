...
class MyEndlessService22 : Service(), DatabaseListenerCallback , LocationListener   {
            ...
            call.enqueue(object : Callback<NewLocationPojo> {
                override fun onResponse(
                    ...
                    try {
                        ...
                        Toast.makeText(this@MyEndlessService22, "" + e.toString(), Toast.LENGTH_SHORT)
                            .show()
